// This is called with the results from from FB.getLoginStatus().
	  ...
	  function statusChangeCallback(response) {
	    ...
	    if (response.status === 'connected') {
	      ...
	      document.getElementById('status').innerHTML = "Please log into Facebook before comment&nbsp;";
	    }
	  }
	  ...
	  function logout(){
		  ...
		  document.getElementById('status').innerHTML =
	        'Please log into Facebook before comment&nbsp;';
	       	$("#firstname").html("");
	        $("#lastname").html("");
	        $(".kwamkidbox form textarea").prop('disabled', true);
